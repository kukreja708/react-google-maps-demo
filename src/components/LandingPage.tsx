...
import { gujarat, rajasthan } from '../coordinates/WestRegion.js';
        ...
        >
          ...
          {Object.entries(regions).map(([key, region]) => (
            <PolygonComponent
              ...
              strokeOpacity={region.strokeOpacity}
